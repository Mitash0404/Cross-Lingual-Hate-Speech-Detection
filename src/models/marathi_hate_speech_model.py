...
for epoch in range(EPOCHS):
    ...
    for task in best_f1:
        if val_f1[task] > best_f1[task]:
            ...
            checkpoint_path = f'./models/marathi_2/best_model_{task}.pth'
...
model_save_path = './models/marathi_2/multi_task_xlm_roberta.pth'
...
tokenizer_save_path = './models/marathi_2/tokenizer_xlm_roberta'
...
optimizer_save_path = './models/marathi_2/optimizer.pth'
torch.save(optimizer.state_dict(), optimizer_save_path)
print(f"Optimizer state_dict saved to {optimizer_save_path}")

# Save the scheduler state
scheduler_save_path = './models/marathi_2/scheduler.pth'
