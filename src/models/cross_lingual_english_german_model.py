"""
Cross-Lingual English-German Hate Speech Detection Model

This module implements a cross-lingual hate speech detection model using XLM-RoBERTa
for transfer learning between English and German languages.

Key Features:
- XLM-RoBERTa-based architecture
- Cross-lingual transfer learning
- Multi-task learning (sentiment + hate speech)
...
# Configuration paths for data and model storage
...
def balance_dataset(df, target_labels, samples_per_class):
    ...
    Args:
        ...
        target_labels (list): List of target labels to balance
    ...
    Raises:
        ValueError: If insufficient samples available for any class
    """
