...
for epoch in range(EPOCHS):
    ...
    for task in best_f1:
        torch.save(model.state_dict(), f'./models/bangla/{epoch}.pth')
        if val_f1[task] > best_f1[task]:
            best_f1[task] = val_f1[task]
            checkpoint_path = f'./models/bangla/best_model_{task}.pth'
...
model_save_path = './models/bangla/multi_task_xlm_roberta.pth'
...
tokenizer_save_path = './models/bangla/tokenizer_xlm_roberta'
...
optimizer_save_path = './models/bangla/optimizer.pth'
torch.save(optimizer.state_dict(), optimizer_save_path)
print(f"Optimizer state_dict saved to {optimizer_save_path}")

# Save the scheduler state
scheduler_save_path = './models/bangla/scheduler.pth'
