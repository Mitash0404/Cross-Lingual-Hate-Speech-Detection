...
This module provides evaluation functionality for Hinglish (Hindi-English mixed)
hate speech detection models using XLM-RoBERTa architecture.

Key Features:
- Hinglish text preprocessing and tokenization
- Model evaluation with comprehensive metrics
- Cross-lingual performance analysis
- Support for both zero-shot and fine-tuned models
